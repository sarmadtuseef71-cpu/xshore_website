...
export const imageAltText: Record<string, string> = {
  ...
  "xshore-mobile-gantry-lifting-gear-uae-05.jpg": "Lifting gear oil gas UAE",
  "xshore-mobile-gantry-lifting-gear-uae-06.jpg": "Mobile gantry Abu Dhabi Mussafah",
  "xshore-mobile-gantry-lifting-gear-uae-07.jpg": "Industrial lifting equipment UAE",
...
export const rentalCategories: Category[] = [
  ...
  },
  {
    ...
    seoTitle: "Pneumatic Equipment Rental UAE | Air Powered Tools & Hire - Xshore",
    seoDescription: "Air-powered industrial tools for hire in the UAE. Pneumatic drills, grinders, impact wrenches, and scaling tools for offshore and industrial site use.",
  ...
  },
  {
    ...
    detailH1: "Electric Power Tools & Equipment 110V / 220V",
    seoTitle: "Electric Power Tool Rental UAE | Industrial Tool Hire Abu Dhabi - Xshore",
    seoDescription: "Industrial electric power tool rental in the UAE. Angle grinders, core drills, and portable tools in 110V and 220V configurations for site use.",
    heroSubtitle: "Angle grinders, core drills, portable power tools, and electrical equipment in 110V and 220V configurations for site use.",
    overviewCopy: "We supply the essential power tools that keep project sites moving. From heavy-duty grinding to precise core drilling, our electric tool fleet is maintained for performance and safety compliance.",
