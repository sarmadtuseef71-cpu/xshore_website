...
const categories = [
  ...
  { title: "Pneumatic Equipment", body: "Air-powered tools for drilling, grinding, scaling, chipping, and impact work. Suitable for offshore and onshore industrial applications.", badge: "Air-Powered", img: "/images/rental/pneumatic-equipment/xshore-pneumatic-equipment-rental-uae-03.webp", alt: "Pneumatic equipment rental for industrial site work in the UAE", to: "/equipment-rental/pneumatic-equipment" },
