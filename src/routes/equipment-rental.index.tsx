  ...
  head: () => ({
    meta: [
      { title: "Equipment Rental UAE | Weekly & Long-Term Industrial Hire | Xshore" },
      {
        name: "description",
        content:
          "Industrial equipment and tools rental across the UAE. Short-term hire from 1 week or long-term project supply - brand new equipment for multi-year contracts. Hydro testing, compressors, welding machines, power tools & more. Abu Dhabi.",
      },
      {
        property: "og:title",
        content: "Equipment Rental UAE | Weekly & Long-Term Industrial Hire | Xshore",
      },
      {
...
const categories = [
  ...
  },
  {
    ...
    badge: "110V / 220V",
    img: "/images/card-titles/xshore-electric-equipment-rental-uae-card-title.webp",
    alt: "Electric equipment rental tools and machines",
    to: "/equipment-rental/electric-equipment-tools",
  },
  {
    ...
    badge: "On Request",
    img: "/images/card-titles/xshore-other-equipment-rental-uae-card-title.webp",
    alt: "Other industrial rental equipment and testing tools",
    to: "/equipment-rental/other-equipment",
  },
];
    ...
    <>
      ...
      <section className="er-hero">
        <div
          ...
          style={{
            backgroundImage: "url('/images/hero/xshore-industrial-equipment-rental-yard-uae.webp')",
          }}
          aria-label="XShore Industrial equipment rental yard with heavy machinery and tools in the UAE"
          role="img"
        />
        ...
        <div className="er-hero-content">
          ...
          <h1>
            Equipment &amp; Tools Rental - Weekly Hire to <em>Multi-Year</em> Project Supply
          </h1>
          <p className="er-hero-sub">
            Need equipment or tools for a week or for three years? We handle both. All units are
            certified and field-ready. Long-term project clients receive brand new equipment
            commissioned specifically for their project.
          </p>
        </div>
      </section>
      ...
      <section className="paths" aria-label="Rental paths">
        ...
        <p className="section-sub">
          Short-term hire for fast-turnaround jobs, or long-term project supply built around your
          timeline. Pick the path that fits.
        </p>
        <div className="paths-grid">
          <div className="path-card" id="short-term-hire">
            ...
            <p>
              Need equipment fast for a short job? We carry stock across all major categories -
              available for weekly or monthly hire. Tell us what you need, where, and when. We
              respond same day.
            </p>
            <button className="path-cta" onClick={() => scrollToQuote("short")}>
          ...
          <div className="path-card" id="long-term-projects">
            ...
            <p>
              Our long-term contracts are built around your project - not our rental schedule. Brand
              new equipment commissioned on day one, maintained throughout the contract, and
              available for the full duration. Currently supporting 3 to 5-year projects across the
              UAE.
            </p>
            <button className="path-cta" onClick={() => scrollToQuote("long")}>
      ...
      <section className="rental" id="categories" aria-label="Equipment categories">
        ...
        <p className="section-sub">
          Certified, well-maintained equipment ready for mobilisation across Abu Dhabi and the wider
          UAE.
        </p>
        ...
        <div className="quote-wrap">
          <div>
            ...
            <p className="section-sub" style={{ marginBottom: 28 }}>
              Tell us what you need - equipment, dates, and site location. We respond same day with
          ...
          {isSuccess ? (
            ...
            >
              ...
              <p style={{ color: "var(--text-dim)", lineHeight: 1.6, margin: 0 }}>
                Your quote request has been sent to our team. We will contact you shortly.
              </p>
            </div>
          ) : (
            <form className="quote-form" onSubmit={handleSubmit}>
              ...
              <div className="qf-field full">
                <label className="qf-label" htmlFor="qf-equipment">
                  Equipment Needed
                </label>
                <input
                  id="qf-equipment"
                  ...
                  className="qf-input"
                  required
                  placeholder="e.g. 750 CFM compressor + hydro test unit"
                />
              </div>
              <div className="qf-field full">
                <label className="qf-label" htmlFor="qf-type">
                  Rental Type
                </label>
                <select
                  id="qf-type"
              ...
              <div className="qf-field">
                <label className="qf-label" htmlFor="qf-from">
                  Required From
                </label>
                <input id="qf-from" name="from" type="date" className="qf-input" required />
              </div>
              <div className="qf-field">
                <label className="qf-label" htmlFor="qf-end">
                  Duration / End Date
                </label>
                <input
                  id="qf-end"
                  name="end"
                  className="qf-input"
                  placeholder="e.g. 3 months or end date"
                />
              </div>
              <div className="qf-field full">
                <label className="qf-label" htmlFor="qf-site">
                  Site Location / Emirate
                </label>
                <input
                  id="qf-site"
                  name="location"
              ...
              <div className="qf-field full">
                ...
                <textarea
                  ...
                  placeholder="Specifications, accessories, delivery notes…"
                />
              </div>

              {isError && (
                <div
                  className="qf-field full"
                  style={{
                    color: "#ff4444",
                    fontSize: 13,
              ...
              <p
                className="qf-note"
                style={{ marginTop: "12px", fontSize: "11px", opacity: 0.7, textAlign: "center" }}
              >
                All hires are subject to our{" "}
                <Link
                  to="/rental-terms"
              ...
              <p className="qf-note">
                Or WhatsApp us directly: <a href="https://wa.me/97122465375">+971 2 246 5375</a> -
