...
const categories = [
  { title: "Hydro Testing Equipment", body: "High-pressure hydrostatic test units for pipeline testing, pressure vessel inspection, and structural integrity verification. Our most-requested product | available for short and long-term hire across the UAE.", badge: "High Pressure", img: "/images/card-titles/xshore-hydro-testing-equipment-rental-uae-card-title.webp", alt: "Hydro testing equipment rental units for industrial pressure testing", to: "/equipment-rental/hydro-testing-equipment" },
  { title: "Air Compressors", body: "185 to 1600 CFM diesel and electric air compressors for all site conditions. Available in multiple configurations for offshore, construction, and industrial applications.", badge: "Diesel / Electric", img: "/images/card-titles/xshore-air-compressors-equipment-rental-uae-card-title.webp", alt: "Industrial air compressor rental equipment", to: "/equipment-rental/air-compressors" },
  { title: "Electric Welding Machines", body: "MMA, MIG, TIG, and submerged arc welding machines for all industrial welding requirements. Available for weekly hire or long-term project deployment.", badge: "MMA / MIG / TIG", img: "/images/card-titles/xshore-welding-equipment-rental-uae-card-title.webp", alt: "Welding machine rental equipment", to: "/equipment-rental/electric-welding-machines" },
  { title: "High Pressure Washers", body: "Cold and hot water industrial pressure washers for surface preparation, cleaning, and maintenance. Suitable for offshore, construction, and plant environments.", badge: "Cold & Hot Water", img: "/images/card-titles/xshore-high-pressure-washers-equipment-rental-uae-card-title.webp", alt: "High pressure washer rental equipment", to: "/equipment-rental/high-pressure-washers" },
  { title: "Mobile Gantry & Lifting Gear", body: "Gantry cranes, chain blocks, lever hoists, wire rope slings, and rigging accessories | all SWL certified and inspection-ready for safe lifting operations.", badge: "SWL Certified", img: "/images/card-titles/xshore-lifting-gear-equipment-rental-uae-card-title.webp", alt: "Mobile gantry lifting gear and chain hoist equipment", to: "/equipment-rental/mobile-gantry-lifting-gear" },
  { title: "Pneumatic Equipment", body: "Air-powered tools for drilling, grinding, scaling, chipping, and impact work. Suitable for offshore and onshore industrial applications.", badge: "Air-Powered", img: "/images/card-titles/xshore-pneumatic-equipment-rental-uae-card-title.webp", alt: "Pneumatic equipment rental tools and air powered machines", to: "/equipment-rental/pneumatic-equipment" },
  { title: "Electric Equipment & Tools", body: "Angle grinders, core drills, portable power tools, and electrical equipment in 110V and 220V configurations for site use.", badge: "110V / 220V", img: "/images/card-titles/xshore-electric-equipment-rental-uae-card-title.webp", alt: "Electric equipment rental tools and machines", to: "/equipment-rental/electric-equipment-tools" },
  { title: "Other Equipment", body: "Gas cutting sets, gas detectors, generators, dehumidifiers, lighting towers, and specialist equipment. Contact us with specific requirements.", badge: "On Request", img: "/images/card-titles/xshore-other-equipment-rental-uae-card-title.webp", alt: "Other industrial rental equipment and testing tools", to: "/equipment-rental/other-equipment" },
];
