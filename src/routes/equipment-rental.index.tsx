...
const categories = [
  ...
  { title: "Mobile Gantry & Lifting Gear", body: "Gantry cranes, chain blocks, lever hoists, wire rope slings, and rigging accessories | all SWL certified and inspection-ready for safe lifting operations.", badge: "SWL Certified", img: "/images/rental/lifting-gear/xshore-mobile-gantry-lifting-gear-uae-05.webp", alt: "Mobile gantry lifting gear rental for industrial projects in the UAE", to: "/equipment-rental/mobile-gantry-lifting-gear" },
  { title: "Pneumatic Equipment", body: "Air-powered tools for drilling, grinding, scaling, chipping, and impact work. Suitable for offshore and onshore industrial applications.", badge: "Air-Powered", img: "/images/rental/pneumatic-equipment/xshore-pneumatic-equipment-rental-uae-05.webp", alt: "Pneumatic equipment rental for industrial site work in the UAE", to: "/equipment-rental/pneumatic-equipment" },
