...
const trading = [
  ...
  { title: "Welding Accessories & Tools", to: "/trading/welding-accessories-tools", img: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&h=300&fit=crop&q=80", p: "All the supporting accessories and tools needed for welding operations, surface prep, and quality control.", items: ["Grinders, brushes & cutting discs","Welding helmets & gloves","Clamps, jigs & positioners","Anti-spatter & cleaning products","NDT accessories & inspection tools"], alt: "Welding accessories and tools supply UAE" },
